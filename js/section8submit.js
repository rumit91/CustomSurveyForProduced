function submitData(obj) {
	...
	$.getJSON("./php/insertSection8.php", {rankedList: rankedList, additionalIdeas: additionalIdeas, sessionID: sessionID}, function () {
		nextPage(obj);
	});
}
function getData (modal) {
	var sessionID = $("body").attr("sessionID");
	$.getJSON("./php/getDataSection8.php", {sessionID: sessionID}, function (data) {
		if(data != null)
		{
			var list = "";
			var i = 1;
