function submitData(obj) {
	...
	$.getJSON("./php/insertSection3.php", {bbcollab: bbcollab, lync: lync, skype: skype, socialMedia: socialMedia, google: google, email:email, additionalIdeas:additionalIdeas, sessionID: sessionID}, function () {
		nextPage(obj);
	});
}
...
function getData (modal) {
	var sessionID = $("body").attr("sessionID");
	$.getJSON("./php/getDataSection3.php", {sessionID: sessionID}, function (data) {
		if(data != null)
		{
