<?php
	...
	$dataExists = "no";
	if(checkIfDataExists($con, "section4"))
	{
		$dataExists = "yes";
	}
?>
...
<body sessionID="<?php echo $_SESSION['id']; ?>" data-exists="<?php echo $dataExists; ?>">
	...
	<div class="container">
		<div class="row">
			...
			<div class="span9">
				<h2 class="sectionHeader">Section 4 - Current & Desired Level of Community among PRODUCED Students</h2>
				<p>Please read each statement in the center column.  Then rate the PRODUCED program based on how it is doing now (left column) and how things should be (right column) <span class="bold-blue">in terms of what makes you feel a sense of community or connection with other PRODUCED students.</span></p>
				<div class="row">
					<div class="span9">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr class="questionRow">
									...
									<td>
										PRODUCED provides opportunities for me to <span class='bold-blue'>contact and communicate</span> with other PRODUCED students outside of class.
									</td>
									<td class="center clickableRadio">
								...
								<tr class="questionRow">
									...
									<td>
										PRODUCED provides opportunities for me to <span class='bold-blue'>share resources and exchange ideas</span> with other PRODUCED students outside of class.
									</td>
									<td class="center clickableRadio">
								...
								<tr class="questionRow">
									...
									<td>
										PRODUCED provides opportunities for me to <span class='bold-blue'>bond and develop friendships</span> with other PRODUCED students outside of class.
									</td>
									<td class="center clickableRadio">
								...
								<tr class="heavy-bottom-border questionRow">
									...
									<td>
										PRODUCED provides opportunities for me to <span class='bold-blue'>study and collaborate</span> with other PRODUCED students on homework and/or projects outside of class.
									</td>
									<td class="center clickableRadio">
								...
								<tr class="questionRow">
									...
									<td>
										PRODUCED provides resources and tools for me to <span class='bold-blue'>contact and communicate</span> with PRODUCED students outside of class.
									</td>
									<td class="center clickableRadio">
								...
								<tr class="questionRow">
									...
									<td>
										PRODUCED provides resources and tools for me to <span class='bold-blue'>share resources and exchange ideas</span> with other PRODUCED students outside of class.
									</td>
									<td class="center clickableRadio">
								...
								<tr class="questionRow">
									...
									<td>
										PRODUCED provides resources and tools for me to <span class='bold-blue'>bond and develop friendships</span> with other PRODUCED students outside of class.
									</td>
									<td class="center clickableRadio">
								...
								<tr class="questionRow">
									...
									<td>
										PRODUCED provides resources and tools for me to <span class='bold-blue'>study and collaborate</span> with other PRODUCED students on homework and/or projects outside of class.
									</td>
									<td class="center clickableRadio">
				...
				<div class="row">
					<div class="span2 offset7">
						<a class="btn btn-primary saveandcontinue" section="4">Save and Continue</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="./js/section4submit.js"></script>
<body>
</html>