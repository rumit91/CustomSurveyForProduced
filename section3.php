<?php
	...
	$dataExists = "no";
	if(checkIfDataExists($con, "section3"))
	{
		$dataExists = "yes";
	}
?>
...
<body sessionID="<?php echo $_SESSION['id']; ?>" data-exists="<?php echo $dataExists; ?>">
	...
	<div class="container">
		<div class="row">
			...
			<div class="span9">
				<h2 class="sectionHeader">Section 3 - Using Communication and Collaboration Tools with PRODUCED Students</h2>
				<p>Below is a list of different online communication and collaboration tools.<br>
				Please indicate the <span class="bold-blue">frequency</span> with which you use each tool to communicate and collaborate with <span class="bold-blue">PRODUCED students outside of class.</span></p>
				<div class="row">
					<div class="span9">
				...
				<div class="row">
					<div class="span6">
						<label>Please list any other online communication or collaboration tools that you use to communicate and collaborate with <span class="bold-blue">PRODUCED students</span> outside of class:</label>
				...
				<div class="row">
					<div class="span2 offset7">
						<a class="btn btn-primary saveandcontinue" section="3">Save and Continue</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="./js/section3submit.js"></script>
<body>
</html>